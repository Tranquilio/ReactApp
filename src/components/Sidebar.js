      ...
      >
        ...
        <div>
          ...
          <div>
            ...
            {/* Insights */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 hover:bg-teal-100 ${pathname.includes('insights') && 'bg-teal-100'}`}>
            ...
            {/* Recommendations */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 hover:bg-teal-100 ${pathname.includes('recommendation') && 'bg-teal-100'}`}>
              <NavLink end to="/profile/recommendation" className={`block text-slate-400 hover:text-black truncate transition duration-150 ${pathname.includes('recommendation') && 'hover:text-black'}`}>
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium ml-3 2xl:opacity-100 duration-200">Recommend</span>
                </div>
              </NavLink>
            </li>

            {/* Survey */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 hover:bg-teal-100 ${pathname.includes('survey') && 'bg-teal-100'}`}>
