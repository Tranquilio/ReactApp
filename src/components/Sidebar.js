  ...
  return (
    ...
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}    
        className={`flex flex-col relative z-40 left-0 top-0 transform h-screen no-scrollbar w-52 p-4 bg-slate-800 transition-all duration-200 ease-in-out`}
      >
        ...
        <div className="mt-auto mb-4 text-slate-200 hover:text-white truncate transition duration-150 hover:bg-slate-900">
          <div className="ml-14">
            <Link to="../">
